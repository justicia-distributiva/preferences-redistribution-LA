...
pacman::p_load(tidyverse, countrycode, car, zoo, wbstats, Hmisc, stargazer, stats,
       ggthemes, data.table, reshape2, scales, xtable, ggrepel, here)
...
figure2
ggsave(here("Output", "Graphs", "Figure2.png"), plot=figure2, height = 4, units="in")
...
figure3
ggsave(here("Output", "Graphs", "Figure3.png"), plot=figure3, height = 10, width = 9, units="in")
...
figure4
ggsave(here("Output", "Graphs", "Figure4.png"), plot=figure4, height = 5, units="in")
...
figure5
ggsave(here("Output", "Graphs", "Figure5.png"), plot=figure5, height = 5, units="in")
