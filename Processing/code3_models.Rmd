...
pacman::p_load(tidyverse, lme4, stats, texreg, car, interplot, sjPlot, 
       ...
       janitor, xtable, matrixStats, scales, ggthemes, here)
...
#Load database
rm(list = ls())
load(here("Output", "LAPOP_Final.RData"))
...
figure_6a
ggsave(here("Output", "Graphs", "Figure6.png"), plot=figure_6a, height = 5, units="in")
...
figure_7a
ggsave(here("Output", "Graphs", "Figure7a.png"), plot=figure_7a, height = 4, units="in")
...
figure_7b
ggsave(here("Output", "Graphs", "Figure7b.png"), plot=figure_7b, height = 4, units="in")
...
ggsave(here("Output", "Graphs", "Appendix3.png"), plot=appendix3, height = 10, width = 9, units="in")
```
...
extra1= ggplot(between, 
  ...
  labs(x = "Inequality", y = "Preference for redistribution", fill="") +
  scale_y_continuous("Preference for redistribution", limits = c(4.8,6.2), 
  ...
  theme(panel.grid.major = element_line(colour = "grey"),
        ...
        panel.background = element_rect(fill = "white"))
extra1
ggsave(here("Output", "Graphs", "Extra1.png"), plot=extra1)
...
extra2= ggplot(within, 
  ...
  scale_y_continuous( "Preference for redistribution", limits = c(4.2,6.7), 
  ...
  theme(panel.grid.major = element_line(colour = "grey"),
        ...
        panel.background = element_rect(fill = "white"))
extra2
ggsave(here("Output", "Graphs", "Extra2.png"), plot=extra2, height = 10, width = 10, units="in")
...
extra3 = ggplot(between, 
  ...
  geom_smooth(method = "lm", colour="black") +
  geom_text(aes(label=country),hjust=-0.1, vjust=-0.5, size=3.5) +
  labs(x = "Economic Development", y = "Preference for redistribution", fill="") +
  scale_y_continuous("Preference for redistribution", limits = c(4.8,6.2), 
                     breaks = c(4.8,5.2,5.6,6)) +
  ...
  theme(panel.grid.major = element_line(colour = "grey"),
        ...
        panel.background = element_rect(fill = "white"))
extra3
ggsave(here("Output", "Graphs", "Extra3.png"), plot=extra3)
...
extra4= ggplot(within, 
  ...
  stat_smooth(size = 1, method = "lm", se = FALSE, colour="black") +
  facet_wrap(~countryname1, ncol=3) +
  labs(x = "Economic Development", y =  "Preference for redistribution") + 
  scale_color_grey(start=0.8, end=0.2, name="Wave") +  
  scale_y_continuous( "Preference for redistribution", limits = c(4.2,6.7), 
                      breaks = c(4.5,5,5.5,6,6.5)) +
  ...
  theme(panel.grid.major = element_line(colour = "grey"),
        ...
        panel.background = element_rect(fill = "white"))
extra4
ggsave(here("Output", "Graphs", "Extra4.png"), plot=extra4, height = 10, width = 10, units="in")
```
