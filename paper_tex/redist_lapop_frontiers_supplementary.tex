...
\begin{tabular}{lrrrrrrr}
  ...
  Total & 5.63 & 1.63 &  & 47.71 & 4.17 & 7.65 & 4.12 \\ 
	...
	\multicolumn{8}{l}{\tiny{variation observed at the individual level. SD years gives the standard deviation of country-year means, or}} \\
	\multicolumn{8}{l}{\tiny{the standard deviation of a data set aggregated at a country-years level, representing the difference in the}} \\
	\multicolumn{8}{l}{\tiny{average between survey years.}}
	\end{tabular}
\end{table}
